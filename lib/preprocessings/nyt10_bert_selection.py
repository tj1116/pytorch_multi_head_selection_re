...
class NYT10_bert_selection_preprocessing(object):
    def __init__(self, hyper):
        ...
        self.relation_vocab_path = os.path.join('../../data/nyt10/multi_head_selection/',
                                                hyper.relation_vocab)
        '''
    ...
    def _gen_one_data(self, dataset):
        ...
        #source  = '../../raw_data/nyt10/train.json'
        #target  = '../../data/nyt10/multi_head_selection/train.json'
...
if __name__=="__main__":
    ...
    hyper = Hyper(os.path.join('../../experiments',
                               'NYT10_bert_selection_re' + '.json'))
    nyt   = NYT10_bert_selection_preprocessing(hyper)
    nyt.gen_all_data()
'''
