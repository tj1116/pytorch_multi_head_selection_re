...
class NYT_bert_selection_preprocessing(object):
    ...
    def _read_line(self, line: str) -> Optional[str]:
        ...
        if 'relationMentions' in instance:
            triples_list = instance['relationMentions']
            ...
            for spo in triples_list:
                subject_org_ner = spo['em1Text']
                object_org_ner  = spo['em2Text']
                ...
                relation_pos = self.relation_vocab[spo['label']]
    ...
    def _gen_one_data(self, dataset):
        ...
        #source  = '../../raw_data/nyt/train.json'
        #target  = '../../data/nyt/multi_head_selection/train.json'
